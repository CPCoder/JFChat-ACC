<div class="grid_16">
	<div class="box">
		<h2>Mitglieder-Verwaltung (Mitglied bearbeiten)</h2><br>
		<div style="text-align:center;">
			Hier kannst du nun die Account-Daten des Users "{USERNAME}" bearbeiten:<br><br>
			{ERRORS}
		</div>
			...
			<table cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td width="60%" style="vertical-align:top; border:0px solid #000000;">
						<input type="text" name="dummy" size="50" maxlength="25" value="{USERNAME}" disabled="disabled"><br>
						(nicht editierbar!)
					</td>
				</tr>
				<tr>
					...
					<td width="60%" style="vertical-align:top; border:0px solid #000000;">
						<input type="password" id="pwd" name="password" size="50">&nbsp; 
				...
				<tr>
					...
					<td width="60%" style="vertical-align:top; border:0px solid #000000;">
						<textarea name="signatur" cols="57" rows="5">{SIGNATUR}</textarea>
					</td>
				</tr>
				<tr>
					<td width="40%" style="vertical-align:top; border:0px solid #000000;">
